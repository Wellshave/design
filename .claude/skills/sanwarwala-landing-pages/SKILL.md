...
description: Build, audit, write or spec high-converting landing pages, sales pages and e-commerce product pages (PDPs). Primary use: building a NEW page from an existing ad creative, so the page continues the exact promise, hook, tone and visuals of the ad that earned the click — one page per creative-angle. Lenses: Arsh Sanwarwala (ThrillX) on page anatomy and CRO, Mark (Brand Builder Academy) on DTC sales pages, offers and market sophistication, Daniel Priestley on scorecard funnels. Covers conversion psychology, above-the-fold rules, headline formulas, social proof, buy boxes, forms, offers and AB testing. ALWAYS use when the user wants to create, improve, critique, score or spec any landing page, sales page, product page, PDP, opt-in or funnel page, buy box or hero section — even without mentioning Arsh or CRO. Triggers: "bouw een landingspagina", "build a landing page", "maak een salespagina", "schrijf een headline", "waarom converteert mijn productpagina niet", "audit this landing page". Bilingual EN/NL.
---
